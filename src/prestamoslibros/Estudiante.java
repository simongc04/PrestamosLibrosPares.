...
public class Estudiante implements Runnable {
    ...
    private static final int TIEMPO_MIN = 1; // 1 minuto
    private static final int TIEMPO_MAX = 3; // 3 minutos
    private static final int DESCANSO_MIN = 1; // 1 minuto
    private static final int DESCANSO_MAX = 2; // 2 minutos
    ...
    public void run() {
        try {
            while (true) {
                // Seleccionar dos libros aleatorios
                ...
                semaphore.acquire(2); // Esperar hasta que ambos libros estén disponibles
                long tiempoEsperaFin = System.currentTimeMillis();
                long tiempoEspera = (tiempoEsperaFin - tiempoEsperaInicio) / 1000; // Tiempo en segundos
                ...
                Thread.sleep(tiempoUso * 1000); // Convertir minutos a milisegundos
